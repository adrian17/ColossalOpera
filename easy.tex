...
\section{Cellular Automata: Rule 90}
...
\section{Letters in Alphabetical Order}
...
\section{Making numbers palindromic}
...
\section{Pronouncing Hexidecimal}
...
\section{Playing the Stock Market}
...
\section{Thue-Morse Sequence Generator}


\index{number theory}
\index{integer sequence}
\index{binary sequence}
\index{Thue-Morse}
\index{infinite}
sequence
...
\section{Vampire Numbers}

\index{composite numbers}
\index{number theory}
...
\section{Abundant and Deficient Numbers}
...
\section{Making Imgur-style Links}

\index{numbers}
\index{base62}
\index{shortened strings}
...
\section{Gold and Treasure: The Beale Cipher}
...
\section{Capitalize The First Letter of Every Word}
...
\section{Finding the Freshest Eggs}
...
\index{graph theory}
\index{graph theory!node}
\index{graph theory!edge}
\index{graph}
...
\section{Integer Sequence Search Part 1}
...
\section{In what year were most presidents alive?}
